...
abstract final class DsTypography {
  ...
  static TextStyle get titleLg =>
      _inter(size: 20, weight: FontWeight.w600, letter: -0.4);
  static TextStyle get titleMd =>
      _inter(size: 16, weight: FontWeight.w600, letter: -0.2);
  ...
  static TextStyle get bodySm => _inter(size: 12, color: DsColors.ink60);

  // ─── Labels ────────────────────────────────────────────────────────────
  static TextStyle get label =>
      _inter(size: 12, weight: FontWeight.w500, color: DsColors.ink80);
  static TextStyle get caption => _inter(size: 11, color: DsColors.ink60);
  ...
  static TextStyle get mono =>
      _mono(size: 11, letter: 0.3, color: DsColors.ink60);

  // ─── Button labels ─────────────────────────────────────────────────────
  static TextStyle get button =>
      _inter(size: 14, weight: FontWeight.w500, letter: -0.1);
}
