...
function Consultation({ goto }) {
  ...
  return (
    <div style={{ paddingBottom: 140 }}>
      <ConsultHeader goto={goto} pct={pct} completed={completed} total={SECTIONS.length} onOpenChecklist={() => setShowChecklist(true)}/>
...
function ConsultHeader({ goto, pct, completed, total, onOpenChecklist }) {
  return (
    <div style={{
